...
func registerMarketRoutes() {
	...
	http.HandleFunc("/api/hikyuu/metadata", hikyuuAPIHandler(hikyuuProxyOnly))
	http.HandleFunc("/api/hikyuu/quality", hikyuuAPIHandler(hikyuuProxyOnly))
	http.HandleFunc("/api/hikyuu/indicators", hikyuuAPIHandler(hikyuuProxyOnly))
	http.HandleFunc("/api/hikyuu/backtest", hikyuuAPIHandler(hikyuuProxyOnly))
...
func registerWebRoutes() {
	...
	http.HandleFunc("/api/market/industry/research", marketAPIHandler(marketProxyOnly))
	http.HandleFunc("/api/market/industry/options", marketAPIHandler(marketProxyOnly))
	...
	http.HandleFunc("/api/market/rzrq/rank", marketAPIHandler(marketProxyOnly))
	http.HandleFunc("/api/market/rzrq/trend", marketAPIHandler(marketProxyOnly))
	...
	http.HandleFunc("/api/macro-events/overview", handleMacroEventOverview)
	http.HandleFunc("/api/macro-events/", handleMacroEventOperations)
